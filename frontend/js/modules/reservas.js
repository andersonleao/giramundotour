...
const ReservasModule = {
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="camposReserva" class="mt-3" style="display:none;">
                        ...
                        <!-- Azul: Localizador + Origem + Adicionar -->
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control text-uppercase" id="azulLocalizador"
                                           placeholder="Ex: INE5TD" maxlength="10">
                                </div>
                                <div class="col-md-4">
    ...
    async adicionarReserva() {
        ...
        if (cia === 'azul') {
            ...
            url = `https://www.voeazul.com.br/br/pt/home/minhas-viagens?pnr=${localizador}&origin=${origem}`;
